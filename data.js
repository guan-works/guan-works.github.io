...
{id:"p07",title:"過濾器說明書(五折彈簧、A4改版款)",category:"print",year:"2020、2026",importance:"normal",description:"",imageDescriptions:["受限於產品包裝尺寸，但必要安裝資訊較多，所以說明書選用彈簧五折方式，將各種內容歸納並分別放置於雙面。","商品包裝改款後，說明書為求資訊容易閱讀，採用A4十字對折方式，查找較為容易。\n將冗長的資訊重新排列組合進行分區，站在消費者更容易閱讀的方式做改版，例如將原有不同段落提及類似的內容再度精簡，並將安裝前的確認要點獨立抽出，改以條列置於正面右上。\n除原有特別注意事項，背面也再將濾心封膜提醒用紅色區塊另外重點標註，讓消費者瀏覽更直覺。"],images:["images/print/p07-01.jpg","images/print/p07-02.jpg"]},
