...
//   width,height  （選填）這件作品第一張圖片（也就是首頁封面圖）的實際
//                 像素寬高，例如 1300、815。填了之後，瀏覽器在圖片還沒
//                 下載完成前就能先算出正確高度、預先保留版面空間，可以
//                 減少下方作品被突然往下推的畫面跳動感（CLS 問題）。不
//                 知道實際尺寸可以先不填，行為跟現在完全一樣。
//   thumbnail     目前不需要手動填這個欄位。首頁封面圖與燈箱下方縮圖列
//                 現在會自動抓對應的縮圖檔案，規則是「原圖檔名 + t，統一
//                 放在 images/thumbs/ 資料夾」，例如 images/ecommerce/
//                 e02-01.jpg 會自動去抓 images/thumbs/e02-01t.jpg；只要
//                 縮圖照這個規則命名、放進 images/thumbs/，就會自動生效，
//                 不用在這裡額外填路徑。主打作品（importance:"featured"）
//                 例外，會直接使用原圖，不套用這個規則（因為主打作品滿版
//                 呈現、尺寸比一般磚塊大很多，縮圖畫質會不夠）。如果某張
//                 圖片的縮圖檔案沒放、或檔名對不上，會自動改顯示暫用色塊
//                 （不會破圖），檔名記得跟原圖一模一樣、只在副檔名前面
//                 多加一個 t，大小寫也要完全一致。
//
...
const works=[
{id:"p01",title:"保健品原料三折DM",category:"print",year:"2022",importance:"featured",description:"以護肝訴求為核心。將PM提供的原始文字與數據重新歸納，拉出主次重點轉化為醒目標題；同時重繪專業機制圖與統計圖表，獨立完成整份文宣封面與內頁的視覺設計，將生硬資料轉化為直覺易讀的文宣。\n※註：由於涉及原公司機密已做馬賽克處理，僅作視覺呈現及部分展示。",width:1300,height:815,images:["images/print/p01-01.jpg"]},
{id:"p02",title:"食品雜誌跨頁廣告設計(已出版)",category:"print",year:"2022",importance:"normal",description:"為保健原料公司之2022年6/7雙月刊 TAIWAN Food News食品雜誌跨頁廣告設計，主要為介紹公司新原料，以其能提神效果為訴求，將人物與背景使用Photoshop合成如活力充沛的狀態，且在不涉及療效的情況下發想主標文案，右頁下方則為公司其他次要主打原料之曝光。",width:1448,height:1086,images:["images/print/p02-01.jpg"]},
{id:"p03",title:"多款A4行銷文宣品設計",category:"print",year:"2020",importance:"normal",description:"多款餐廚用品的廣告傳單設計，用以推廣給行銷團購業主。",width:1484,height:1639,images:["images/print/p03-01.jpg"]},
{id:"p04",title:"品牌特賣會與團購網活動系列設計",category:"print",year:"2023",importance:"normal",description:"– 旗幟力求資訊清晰，重點文字置於中央；特賣款選用通用向量圖示呈現商品類別，避免受限於單一品項，讓宣傳用途更廣泛。\n– 團購款則以清新綠色為基調，結合生鮮食材、飛濺水花與綠葉元素，營造豐富飽滿的視覺層次，直觀凸顯商品的新鮮品質。\n\n材質與尺寸：雙透布桃太郎旗，60x150cm",width:1448,height:1086,images:["images/print/p04-01.jpg","images/print/p04-02.jpg","images/print/p04-03.jpg"],imageDescriptions:["","特賣活動宣傳單，主題與日期採用光芒聚焦設計吸引目光，並將主打商品、活動贈品、付款方式及地圖資訊妥善分區規劃，讓促銷內容一目了然。\n材質與尺寸：100g銅版紙A4雙面印刷。 ","廠內乳膠墨帆布360X90cm"]},
{id:"p05",title:"汽車美容名片與VIP會員卡設計",category:"print",year:"2016",importance:"normal",description:"",imageDescriptions:["名片正面使用車體特寫，讓人能直覺辨識產業類型；下方整合主要服務項目，背面則以汽車內裝為背景，在保有視覺情境的同時，確保地圖與聯絡資訊清晰易讀。\n使用頂級卡雙面霧膜+局部上光","會員卡做為消費紀錄用，全採內裝背景為輔且不上模，以便後續書寫或蓋章，流水號則選用燙金作為凸顯。\n使用頂級象牙卡，正面流水號燙金"],width:1920,height:1200,images:["images/print/p05-01.jpg","images/print/p05-02.jpg"]},
{id:"p06",title:"烘焙書籍插頁廣告",category:"print",year:"2021",importance:"normal",description:"配合知名烘焙師書籍之插頁廣告，搭配食譜內容挑選合適商品，以色塊標示規格重點與俐落文案，降低生硬廣告感，使版面自然融入書籍整體風格。",imageDescriptions:[""],width:1536,height:1024,images:["images/print/p06-01.jpg"]},
{id:"p07",title:"過濾器說明書(五折彈簧、A4改版款)",category:"print",year:"2020、2026",importance:"normal",description:"",imageDescriptions:["受限於產品包裝尺寸，但必要安裝資訊較多，所以說明書選用彈簧五折方式，將各種內容歸納並分別放置於雙面。","因應包裝改款，說明書重新規劃為 A4 十字對折形式。重組原本零散且重複性高的資訊，將「安裝前確認」獨立條列於首頁右上，並利用色彩規劃於背面重點強化濾心拆封等安全提醒，大幅提升操作指引的直覺性與易讀性。"],width:1449,height:1086,images:["images/print/p07-01.jpg","images/print/p07-02.jpg"]},
{id:"p08",title:"台北美容保養．生技保健大展系列廣告及燈箱",category:"print",year:"2022",importance:"normal",description:"",imageDescriptions:["以公司主要產品劑型與主力原料作為視覺主軸，將粉劑、膠囊、苦瓜與蔬果酵素等素材透過Photoshop重新合成。封面以上半部影像、下半部留白的方式安排版面，將年份與目錄資訊集中於下方，讓豐富的素材與文字資訊維持清楚的層次與視覺平衡。","上下翻轉素材檔案，先消除公司未有之精油物品，增加主力苦瓜原料與缽內粉劑，再合成蔬果食材，最終再增加膠囊劑型，讓目錄封面的元素更貼合公司各種劑型與原料。","- 左上：產品展示背板：延續該年度公司總目錄的視覺風格，依據實際展示空間重新調整物品配置，使背景圖像與展示商品之間保有適當的視覺區隔，同時維持整體識別與畫面一致性。\n- 右上：兩張燈箱設計：展場所有燈箱為三個設計合作，除沿用舊設計做些微變動外，此兩款燈箱為此次展覽新設計，皆依據原料特性(保肝、心血管)做不同的效果展示。"],width:1536,height:1024,images:["images/print/p08-01.jpg","images/print/p08-02.gif","images/print/p08-03.jpg"]},
{id:"p09",title:"食譜書插頁廣告設計",category:"print",year:"2022",importance:"normal",description:"針對商品特性發想核心標題，並以專業主廚形象作為視覺焦點，傳遞工欲善其事，必先利其器，營造出使用這些工具也能像主廚般專業的信賴感。",width:2170,height:1800,images:["images/print/p09-01.jpg"]},


{id:"k01",title:"保健沖泡飲品包裝編排與鋁袋設計",category:"packaging",year:"2022",importance:"normal",description:"以產品主原料納豆紅麴之功效，針對可維持血液流動順暢，支持心血管與循環健康為發想概念，呈現紅血球與沖泡飲流動的視覺意象作為包裝呈現。\n※註：此為廠商產品包合成示意圖，雖非最終成品圖，但已為選用設計，切勿擅自轉載、竊取盜用或抄襲。",width:1534,height:992,images:["images/packaging/k01-01.jpg","images/packaging/k01-02.jpg","images/packaging/k01-03.jpg"]},
{id:"k02",title:"品牌不織布提袋圖案設計",category:"packaging",year:"2017",importance:"normal",description:"此為品牌LOGO強化概念，作為百貨櫃位與展覽使用。\n※註：模擬圖為AI生成再經人工合成修正。",width:1448,height:1086,images:["images/packaging/k02-01.jpg","images/packaging/k02-02.jpg"]},
{id:"k03",title:"過濾器飛機盒編排設計",category:"packaging",year:"2020",importance:"featured",description:"主要依據盒形刀模作內容編排設計，以簡約水波紋搭配產品正面及特點ICON，呈現乾淨清徹的意象。\n材質與後加工：300g灰銅卡裱白F浪，單面霧膜，產品局部上光，LOGO打凸設計。",width:1500,height:938,images:["images/packaging/k03-01.jpg","images/packaging/k03-02.jpg"]},
{id:"k04",title:"平底鍋吊卡資訊視覺設計",category:"packaging",year:"2017",importance:"normal",description:"針對百貨櫃位掛架與參展平放陳列情境，採圓形裁切與鍋型呼應，半包覆式吊卡結構完整保留把手握感與鍋底展示，搭配豐富配色料理情境圖來吸引消費者，兼具資訊傳達與商品展示的功能。",width:1024,height:1470,images:["images/packaging/k04-01.jpg","images/packaging/k04-02.jpg"]},
{id:"k05",title:"炒鍋瓦楞提盒視覺編排設計",category:"packaging",year:"2020",importance:"normal",description:"兼具百貨櫃位陳列或網購出貨，採用彩色瓦楞提盒設計，依據印刷廠客製刀模做視覺編排呈現。\n正反面以商品白圖搭配產品特點，讓商品外觀與重要資訊清楚呈現，側邊輔以細節圖片與商品規格。",width:1448,height:1086,images:["images/packaging/k05-01.jpg","images/packaging/k05-02.jpg"]},
